...
//                     <p className="mt-2 font-semibold">AppointmentContainer fee: <span className="text-blue-600">${doctor.fee || 0}</span></p>
//                 </div>
//             </div>
//
...
import AppointmentContainer from "../BookAppointment/AppointmentContainer";
// import RelatedDoctors from "../BookAppointment/RelatedDoctors";
